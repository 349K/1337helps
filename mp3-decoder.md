...
usage: mp3-decoder [option(s)] [file(s) | URL(s) | -]
...
See the manpage mpg123(1) or call mp3-decoder with --longhelp for more parameters and information.
