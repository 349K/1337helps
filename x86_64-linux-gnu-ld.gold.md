# x86_64-linux-gnu-ld.gold command Help
 
 This command seen on Linux kali 4.6.0-kali1-amd64 #1 SMP Debian 4.6.4-1kali1 (2016-07-21) x86_64 GNU/Linux. For further information please check [docs.kali.org](docs.kali.org) and have a nice day buddy ;) 

~~~

Usage: x86_64-linux-gnu-ld.gold [options] file...
Options:
  ...
  --no-fix-cortex-a53-843419  (AArch64 only) Do not fix Cortex-A53 erratum 843419.
  --fix-cortex-a53-835769     (AArch64 only) Fix Cortex-A53 erratum 835769.
  --no-fix-cortex-a53-835769  (AArch64 only) Do not fix Cortex-A53 erratum 835769.
  ...
  --no-long-plt               (ARM only) Do not generate long PLT entries
  -g                          Ignored
  ...
  --rosegment-gap OFFSET      Set offset between executable and read-only segments
  ...
  --stub-group-size SIZE      (ARM, PowerPC only) The maximum distance from instructions in a group of sections to their stubs.  Negative values mean stubs are always after (PowerPC before) the group.  1 means use default size.
  ...
  -Ttext-segment ADDRESS      Set the address of the text segment
  -Trodata-segment ADDRESS    Set the address of the rodata segment
  ...
  -z global                   Make symbols in DSO available for subsequently loaded objects
  ...
  -z stack-size=SIZE          Set PT_GNU_STACK segment p_memsz to SIZE
  ...
  -z buildd                   Dummy z option
x86_64-linux-gnu-ld.gold: supported targets: elf32-iamcu elf32-i386 elf32-i386-freebsd elf32-i386-nacl elf32-x86-64 elf32-x86-64-freebsd elf32-x86-64-nacl elf64-x86-64 elf64-x86-64-freebsd elf64-x86-64-nacl
x86_64-linux-gnu-ld.gold: supported emulations: elf_iamcu elf_i386 elf_i386_nacl elf32_x86_64 elf32_x86_64_nacl elf_x86_64 elf_x86_64_nacl
