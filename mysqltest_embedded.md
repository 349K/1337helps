# mysqltest_embedded command Help
 
 This command seen on Linux kali 4.6.0-kali1-amd64 #1 SMP Debian 4.6.4-1kali1 (2016-07-21) x86_64 GNU/Linux. For further information please check [docs.kali.org](docs.kali.org) and have a nice day buddy ;) 

~~~

mysqltest_embedded  Ver 3.3 Distrib 5.6.30, for debian-linux-gnu (x86_64)
...
Usage: mysqltest_embedded [OPTIONS] [database] < test_file
...
compress                          FALSE
cursor-protocol                   FALSE
database                          (No default value)
debug-check                       FALSE
debug-info                        FALSE
host                              (No default value)
include                           (No default value)
logdir                            
mark-progress                     FALSE
max-connect-retries               500
max-connections                   128
port                              0
ps-protocol                       FALSE
quiet                             FALSE
...
verbose                           FALSE
view-protocol                     FALSE
opt-trace-protocol                FALSE
explain-protocol                  FALSE
json-explain-protocol             FALSE
connect-timeout                   120
