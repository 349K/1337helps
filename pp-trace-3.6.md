...
USAGE: pp-trace-3.6 [options] <source0> [... <sourceN>] <arguments to be passed to front end>...
...
OPTIONS:
  ...
  -ignore=<string>                                - Ignore callbacks, i.e. "Callback1, Callback2...".
  ...
  -output=<string>                                - Output trace to the given file name or '-' for stdout.
